  ...
  return (
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-green-600 transition duration-150 ease-in-out hover:shadow-lg active:bg-green-800 mt-6" type="submit">Sign Up</button>
